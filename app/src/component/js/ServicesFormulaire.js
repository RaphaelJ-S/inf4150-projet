              ...
              <div key={elem.id}>
                <div className="form-floating">
                  ...
                  >
                    ...
                    <option value="Travail du conjoint">
                      Travail du conjoint
                    </option>
                    <option value="École">École</option>
                    <option value="Transport en commun">
                      Transport en commun
                    </option>
                    <option value="Épiceries">Épiceries</option>
                    <option value="Centres Commerciaux">
                      Centres Commerciaux
                    </option>
                    <option value="Centres Récréatifs">
                      Centres Récréatifs
                    </option>
                    ...
                    <option value="Service d'incendie">
                      Service d'incendie
                    </option>
